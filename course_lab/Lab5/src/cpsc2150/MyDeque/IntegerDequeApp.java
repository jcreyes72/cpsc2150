...
public class IntegerDequeApp {
    public static void main(String args[]){
        ...
        while (true) {
            ...
            // i. Add to the end of the deque
            if (userIn.equals("1")) {
                System.out.println("\nWhat integer would you like to add to the end of the deque?");
                userIn = in.next();
            ...
            // ii. Add to the front of the deque
                ...
                System.out.println("\nWhat integer would you like to add to the front of the deque?");
                userIn = in.next();
            ...
            // iii. Remove from the front of the deque
                ...
                if (q.length() == 0){
                    ...
                    System.out.println("\nRemoving integer from front of deque...");
                    q.dequeue();
                    System.out.println("\nThe deque is now: " + q);
                }
                continue;
            ...
            // iv. Remove from the end of the deque
                ...
                if (q.length() == 0){
                    ...
                    System.out.println("\nRemoving integer from end of deque...");
                    q.removeLast();
                    System.out.println("\nThe deque is now: " + q);
                }
                continue;
            ...
            // v. Peek at the front of the deque
                ...
                if (q.length() == 0){
                    ...
                    System.out.println("\nThe integer at the front of the deque is: " + q.peek());
                }
                continue;
            }
            // vi. Peek at the end of the deque
                ...
                if (q.length() == 0){
                    ...
                    System.out.println("\nThe integer at the end of the deque is: " + q.endOfDeque());
                }
                continue;
            }
            // vii. Insert into a position in the deque
            else if (userIn.equals("7")) {
                System.out.println("What position would you like to add your integer to?");
                String posChoice = in.next();
                // Setting user position input as an integer
                int posAsInt = Integer.parseInt(posChoice);
                System.out.println("What integer would you like to add at this position?");
                userIn = in.next();
            ...
            // viii. Remove a value from any position in the deque and return it
                ...
                if (q.length() == 0){
                    ...
                    System.out.println("What position would you like to remove an integer from?");
                    String posChoice = in.next();
                    // Setting user position input as an integer
                    int posAsInt = Integer.parseInt(posChoice);
            ...
            // ix. Peek at a value at any position in the deque
                ...
                if (q.length() == 0){
                    ...
                    int posAsInt = Integer.parseInt(posChoice);
                    System.out.println("\nThe integer at this position is: " + q.get(posAsInt - 1));
                }
                continue;
            }
            // x. Returns the length of the deque
